...
class TextAss extends Taro.Component {
  ...
  wechatClick () {
    Taro.chooseMessageFile({
      count: 1,
      type: 'file',
      extension: ['doc', 'ppx', 'xls', 'xlsx', 'docx', 'pdf', 'pdfx', 'pptx'],
      success (result) {
    ...
    return (
      ...
      <View>
        ...
        <AtActionSheet
          ...
          <AtActionSheetItem onClick={this.wechatClick}>微信文件</AtActionSheetItem>
          <AtActionSheetItem onClick={this.textClick}>本地文件</AtActionSheetItem>
        </AtActionSheet>
      </View>
