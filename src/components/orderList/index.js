...
import './index.scss'
import toPreview from '../../asset/image/to_preview.png'
import unPreview from '../../asset/image/un_preview.png'
import toUpload from '../../asset/image/to_upload.png'
import unUpload from '../../asset/image/un_upload.png'
          ...
          return (
            ...
            >
              ...
              <View className='advert'>
                ...
                <View className='advert-content'>
                  ...
                  <Image className='preview'
                    src={v.order_state !== '4' ? toPreview : unPreview}
                    onClick={v.order_state !== '4' ? this.preview.bind(this, k) : null}
                  />
                  <Image className='upload'
                    src={v.order_state === '1' || v.order_state === '2' ? toUpload : unUpload}
                    ...
                    timeList && timeList.map((p, q) => {
                      ...
                      return (
                        ...
                        <View className='seconds'
                          onClick={v.order_state === '1' || v.order_state === '2' ? this.chooseTime.bind(this, q, k) : null}
              ...
              <View className='period'>
                ...
                <View className='period-content'>{v.create_time}~{v.create_time}</View>
              </View>
              {
                v.order_state !== '4'
                  ? (<View className='equipment'>
                    ...
                    <View className='equipment-content'>
                      {v.equipment && v.equipment.map((m, n) => {
                        return (
                          <Text taroKey={n} className='equipment-id'
                          >{m}</Text>
                        )
                      })}
                    </View>
